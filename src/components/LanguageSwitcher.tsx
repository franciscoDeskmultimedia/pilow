          ...
          {languages.map((lang) => (
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 text-left hover:bg-pilow-lavender-light dark:hover:bg-slate-700 transition-colors ${
                locale === lang.code 
                  ? 'bg-pilow-ocean/10 dark:bg-pilow-ocean/20 text-pilow-ocean-dark dark:text-cyan-400 font-semibold' 
            ...
            >
              ...
              {locale === lang.code && (
                <svg className="w-4 h-4 ml-auto text-pilow-ocean-dark dark:text-cyan-400" fill="currentColor" viewBox="0 0 20 20">
